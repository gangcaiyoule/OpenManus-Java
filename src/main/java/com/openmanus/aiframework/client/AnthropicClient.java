...
public class AnthropicClient extends AbstractAiProviderClient {

    public AnthropicClient(ProviderConfig providerConfig,
    ...
    protected void enrichHeaders(Map<String, String> headers) {
        headers.put("x-api-key", providerConfig.getApiKey());
        headers.put("anthropic-version", "2023-06-01");
    }

    @Override
    protected String buildChatUrl(ChatRequestEnvelope request) {
        return providerConfig.getBaseUrl().replaceAll("/$", "") + "/v1/messages";
    }
