...
public final class TaskStateContextInjector {
    ...
    public TaskStateContextInjector() {
        this(TaskExecutionState.Budget.defaults());
    }

    public TaskStateContextInjector(TaskExecutionState.Budget taskStateBudget) {
        this.taskStateBudget = taskStateBudget == null
